...
const Tree = (_a) => {
    ...
    return (React.createElement("div", { className: "group" }, data.map((item, idx) => {
        return (React.createElement("div", { key: item.path, className: "child node-row" },
            React.createElement("span", { onClick: (e) => {
                    data.addSubNode(idx, { key: "value" });
                } }, "➕"),
            React.createElement("input", { value: item.key, onChange: (e) => {
                    data.updateNode(idx, e.target.value);
                } }),
            React.createElement("span", { className: "spacer" }),
            item.type === "object" ? (React.createElement(React.Fragment, null,
                React.createElement("input", { value: "Object", disabled: true }),
                React.createElement("span", { onClick: () => data.deleteNode(idx) }, "\uD83D\uDDD1"),
                React.createElement(Tree, Object.assign({ data: item.value }, props)))) : (React.createElement(React.Fragment, null,
                React.createElement("input", { value: item.value, onChange: (e) => {
...
class TreeWrapper extends React.Component {
    ...
    render() {
        return (React.createElement("div", { className: "react-json-tree" },
            React.createElement(Tree, { data: this.jsonTree })));
    }
}
