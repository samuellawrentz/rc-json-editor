...
# rc-json-editor
A simple react component that parses your JSON and allows you to render your UI based on it.
...
## The How?
We have a parser in place that parses your JSON and converts it into an array of sorts, from which you will able to render your JSON Tree with your own components.
